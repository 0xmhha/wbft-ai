...
| 섹션 | 시작 라인 | 내용 |
|------|-----------|------|
| §1. 빌드 요약 | L19 | 바이너리 수(13), 패키지 수(165), 파일 수(791) |
| §2. 바이너리 목록 | L29 | 13개 바이너리 및 역할 (gwemix, bootnode, clef 등) |
| §3. 패키지 목록 | L49 | 165개 패키지 카테고리별 (go-wbft 고유 ★ 표시) |
| §4. 카테고리별 집계 | L318 | 20개 카테고리 패키지·파일 수 집계 테이블 |
| §5. go-wbft 고유 코드 요약 | L346 | 전용 패키지 14개, 기존 패키지 내 고유 파일 6개 |
